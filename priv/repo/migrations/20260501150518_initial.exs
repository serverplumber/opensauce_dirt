defmodule OpenSauce.Repo.Migrations.Initial do
  ...
  def down do
    ...
    drop_if_exists unique_index(:inventory_materials, [:sku], name: "inventory_materials_sku_index")

    drop_if_exists unique_index(:inventory_materials, [:name], name: "inventory_materials_name_index")
