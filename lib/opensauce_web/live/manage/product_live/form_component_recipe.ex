defmodule OpenSauceWeb.ProductLive.FormComponentRecipe do
  @moduledoc false
  use OpenSauceWeb, :live_component

  alias AshPhoenix.Form
  alias OpenSauce.Catalog
  alias OpenSauce.Catalog.Services.BOMRecipeSync
  alias Decimal, as: D
  ...
  defp get_material_unit(materials_map, components_form) do
    case material_for_form(materials_map, components_form) do
      nil -> ""
      material -> OpenSauce.Types.Unit.abbreviation(material.unit)
    end
  end
