defmodule OpenSauceWeb.ProductLive.Show do
  @moduledoc false
  ...
  @impl true
  def handle_info({OpenSauceWeb.ProductLive.FormComponentPhotos, {:saved, _}}, socket) do
    product =
  ...
  @impl true
  def handle_info({OpenSauceWeb.ProductLive.FormComponentRecipe, {:saved, _}}, socket) do
    product =
      Catalog.get_product_by_sku!(socket.assigns.product.sku,
        load: [
          :markup_percentage,
  ...
  def handle_info({OpenSauceWeb.ProductLive.FormComponent, {:saved, _}}, socket) do
    product =
      Catalog.get_product_by_sku!(socket.assigns.product.sku,
        load: [
          :markup_percentage,
