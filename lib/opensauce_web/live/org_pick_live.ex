defmodule OpenSauceWeb.OrgPickLive do
  ...
  def render(assigns) do
    ...
    <div
      class="dark-screen"
      style="min-height:100dvh;background:#16140E;font-family:'Hanken Grotesk',system-ui,sans-serif;color:#F4EFE2;-webkit-font-smoothing:antialiased;display:flex;flex-direction:column;"
    >
      <%!-- top bar --%>
      <div style="height:64px;flex:0 0 auto;display:flex;align-items:center;justify-content:space-between;padding:0 24px;">
        ...
        <a
          href={~p"/sign-out"}
          style="font-size:13px;font-weight:600;color:#9A9384;text-decoration:none;"
        >
          Sign out
        </a>
      </div>
      ...
      <div style="padding:6px 24px 40px;flex:1;display:flex;flex-direction:column;">
        ...
        <div style="margin-top:24px;display:flex;flex-direction:column;gap:12px;">
          ...
          >
            <span
              :if={idx == 0}
              style="position:absolute;top:14px;right:15px;font-size:10.5px;font-weight:700;letter-spacing:0.06em;text-transform:uppercase;color:#54B57E;"
            >
              Last used
            </span>
            ...
            <svg
              style={"flex:0 0 auto;#{chevron_color(m.role, idx == 0)}"}
              width="22"
              height="22"
              viewBox="0 0 24 24"
              fill="none"
        ...
        >
          ...
          <div>
            ...
            <div style="margin-top:3px;font-size:12.5px;color:#9A9384;">
  ...
  defp org_card_style(_role, last_used) do
    border =
      if last_used,
        do:
          "border-color:#54B57E;box-shadow:0 0 0 3px rgba(84,181,126,0.30),0 1px 2px rgba(0,0,0,0.4),0 12px 30px rgba(0,0,0,0.45);",
