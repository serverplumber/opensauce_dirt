defmodule OpenSauce.Orders.Order do
  @moduledoc false
  use Ash.Resource,
    otp_app: :opensauce,
  ...
  alias OpenSauce.Orders.Changes.CalculateTotals
  alias OpenSauce.Orders.Changes.ValidateConstraints
  alias OpenSauce.Orders.Order.Types.PaymentStatus
  alias OpenSauce.Orders.Order.Types.Status
